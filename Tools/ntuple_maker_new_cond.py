...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/eos/cms/store/user/zhangyi/validation/FF9E45DF-DC15-E749-8E0C-0EE9A37361CD.root'
),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '101X_dataRun2_HLT_v7', 'Tag,HcalL1TriggerObjectsRcd,sqlite_file:../HcalL1TriggerObjects.db')
